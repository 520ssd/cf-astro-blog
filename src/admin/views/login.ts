...
<body${hasBackgroundImage ? ' class="has-bg-image"' : ""}>
	...
	<main class="entry-shell">
		<header class="entry-header">
			<a href="/" class="entry-brand" aria-label="返回 jy先生和jx女士 爱的小窝 首页">
				<img
					src="https://xy.520jy.eu.cc/f/4BHG/IMG_4310.png"
					alt=""
					class="entry-brand-logo"
				/>
				<span>jy先生和jx女士 爱的小窝</span>
			</a>
		</header>
		...
		<section class="entry-panel">
			<div class="entry-content">
				...
				<div class="entry-notice" role="note">
					...
					<span>此后台仅供 <strong>jy</strong> 登录使用，暂不对外开放。</span>
				</div>
		...
		<p class="entry-footer">jy先生和jx女士 爱的小窝 &mdash; 后台入口</p>
	</main>
</body>
</html>`;
}
